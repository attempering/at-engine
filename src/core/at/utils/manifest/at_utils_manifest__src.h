    ...
    int silent)
{
  ...
  {
    fprintf(stderr, "assuming default: utils->manifest->filename = \"at-manifest.dat\", key: manifest_file\n");
  }
  ...
  {
    fprintf(stderr, "assuming default: utils->manifest->arr_max_items = 3, key: manifest_arr_max_items\n");
  }
